        ...
        <div className="container mx-auto">
          <div className='flex items-center justify-between relative'>
            <div className='flex items-center gap-x-[120px]'>
              <a href="#home">
                <img src={Logo} alt="DataMaster logo" />
              </a>
            ...
            <button className='btn btn-quaternary flex items-center gap-x-[10px] sm:gap-x-[20px] group'>
              <span className='smaller:hidden sm:block'>Testar demonstração grátis</span><span className='sm:hidden'>Testar</span><BsArrowRight className='text-2xl text-accent-primary group-hover:text-white transition'/>
            </button>
